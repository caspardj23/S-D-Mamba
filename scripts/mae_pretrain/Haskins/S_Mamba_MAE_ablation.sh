...
#   A. mask_ratio: {0.3, 0.4, 0.5}        (block_size=8 fixed)
#   B. block_size: {4, 8, 16, 32}          (mask_ratio=0.4 fixed)
#   C. pre-train epochs: {20, 50, 100}     (best mask config)
#   D. fine-tune strategy: scratch vs freeze vs partial vs full
#
